    ...
    <header className="bg-white shadow-md p-4 sticky top-0 z-20">
      <div className="container mx-auto flex justify-between items-center">
        <div className="flex items-center space-x-3">
            ...
            <h1 className="text-xl md:text-2xl font-bold text-gray-800">Test PAI: Deterioro Cognitivo</h1>
        </div>
         {quizState !== 'not_started' && (
           <button onClick={handleRestart} className="text-sm font-semibold text-cyan-600 hover:text-cyan-800 transition-colors">Reiniciar</button>
        )}
      </div>
    </header>
  );
