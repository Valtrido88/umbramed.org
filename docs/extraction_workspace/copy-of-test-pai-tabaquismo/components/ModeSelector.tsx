  ...
  return (
    <div className="bg-white p-8 rounded-lg shadow-xl max-w-2xl mx-auto animate__animated animate__fadeIn">
      ...
      <p className="text-center text-gray-600 mb-8">
        Este test está basado en la "Guía de Bolsillo para el Tratamiento del Tabaquismo y Productos Relacionados" de la semFYC (2024) y las fichas técnicas de Citisina. Las respuestas han sido verificadas. ¡Mucha suerte!
      </p>
