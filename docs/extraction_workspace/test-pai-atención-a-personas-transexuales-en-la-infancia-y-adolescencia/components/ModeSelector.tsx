  ...
  return (
    <div className="bg-white p-8 rounded-lg shadow-xl max-w-2xl mx-auto animate__animated animate__fadeIn">
      ...
      <p className="text-center text-gray-600 mb-8">
        Este test está basado en el PAI de Atención Sanitaria a Personas Transexuales en la Infancia y Adolescencia de la Junta de Andalucía (Ed. 2016). Las respuestas han sido verificadas. ¡Mucha suerte!
      </p>
