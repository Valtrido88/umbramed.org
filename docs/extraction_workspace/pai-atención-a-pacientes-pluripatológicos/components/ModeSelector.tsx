  ...
  return (
    <div className="bg-white p-8 rounded-lg shadow-xl max-w-2xl mx-auto animate__animated animate__fadeIn">
      ...
      <p className="text-center text-gray-600 mb-8">
        Este test está basado en el Proceso Asistencial Integrado de Atención a Pacientes Pluripatológicos del SAS (3ª Ed. 2018). Las respuestas han sido verificadas. ¡Mucha suerte!
      </p>
